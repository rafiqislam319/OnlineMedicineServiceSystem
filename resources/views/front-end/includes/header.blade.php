<div class="header">
    <div class="header-top">
        <div class="container">
            <div class="top-left">
                <a href="#"> Help  <i class="glyphicon glyphicon-phone" aria-hidden="true"></i> +01686313821</a>
            </div>
        ...
        <div class="container">
            <div class="logo-nav">
                <div class="logo-nav-left">
                    <h1><a href="{{url('/')}}">E-Pharma <span>Shop anywhere</span></a></h1>
                </div>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                ...
                                {{--Note:: though this session Customerid & name should come from FrontEndSignUpController but here it has come from checkoutController for my little mistake --}}
                                    @if(Session::get('customerId'))
                                        <li class="nav-item dropdown"><a class="nav-link text-white dropdown-toggle" data-toggle="dropdown" href="">{{ Session::get('customerName') }} <span class="caret"></span></a>
